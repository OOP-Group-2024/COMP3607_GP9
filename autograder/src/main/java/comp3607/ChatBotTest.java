...
public class ChatBotTest extends FileTest{
    ...
    public void setUp(Report report){
        ...
        addVariableTest("static", "int", "messageLimit", chatBot);
        addVariableTest("static", "int", "messageNumber", chatBot);
        ...
        addMethodTest("public", "int", List.of(), "getTotalNumMessagesRemaining", chatBot);
        addBehaviourTest(List.of("getTotalNumMessagesRemaining","messageNumber"), List.of(none,none), List.of(),0, 10, chatBot);
        ...
        addBehaviourTest(List.of("generateResponse","numResponsesGenerated"), List.of(none,none), List.of(), 1, "1 ChatGPT-3.5" , chatBot); //messageNumber++
        addMethodTest("public", "java.lang.String", List.of(String.class), "prompt", chatBot); 
        addBehaviourTest(List.of("prompt","messageNumber"), List.of(none,List.of("hello").toArray()), List.of(),3 , "3 ChatGPT-3.5", chatBot); //messageNumber + 2 for returnTest invocation and valueTest invocation
