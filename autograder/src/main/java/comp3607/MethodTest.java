...
public class MethodTest extends Test {
    ...
    public void checkAccessModifier(Method method, Report report) {
        ...
        try{
            ...
            report.addPassedTest(String.format("Method: %-20s Correct access modifier", methodName));    
        }catch (AssertionError e){
            report.addError(String.format("Method: %-20s Incorrect access modifier. Expected - %s, Declared - %s", methodName, expectedAccessModifier, actualModifier));
        }
    }
    public void checkReturnType(Method method, Report report) {
        ...
        try{
            ...
            report.addPassedTest(String.format("Method: %-20s Correct return type", methodName));    
        }catch (AssertionError e){
            report.addError(String.format("Method: %-20s Incorrect return type. Expected - %s, Declared - %s", methodName, expectedReturnType, actualReturnType));
        }
    }
    ...
    public void checkParameterTypes(Method method, Report report) {
        ...
        try{
            ...
            report.addPassedTest(String.format("Method: %-20s Correct paramter types", methodName));    

        }catch(AssertionError e){
            report.addError(String.format("Method: %-20s Incorrect parameter types. Expected - %s, Declared - %s", methodName, expectedParameterTypes, parameterTypes));
        }
    }
